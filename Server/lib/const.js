...
*/
	'EKT': { lang: "en",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "unk", "wcw", "wpn", "onl", "ons" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'ESH': { lang: "en",
		rule: "Classic",
		opts: [ "ext", "mis", "unk", "wcw", "wpn", "onl", "ons" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KKT': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "k32", "unk", "ezm", "wcw", "wpn", "onl", "ons" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KSH': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "unk", "ezm", "wcw", "wpn", "onl", "onl", "ons" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KAP': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "unk", "ezm", "wcw", "wpn", "onl", "ons" ],
		time: 1,
		ai: true,
		big: false,
		_back: true, // ?
	...
	'KDA': { lang: "ko",
		rule: "Daneo",
		opts: [ "ijp", "mis", "ezm", "wcw", "wpn", "onl", "ons" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
