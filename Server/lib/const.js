...
*/
	...
	'KSH': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "unk", "ezm", "wcw", "wpn", "onl", "onl" ],
		time: 1,
		ai: true,
		big: false,
		ewq: true
	...
	'KAP': { lang: "ko",
		rule: "Classic",
		opts: [ "man", "ext", "mis", "loa", "str", "unk", "ezm", "wcw", "onl" ],
		time: 1,
		ai: true,
		big: false,
		_back: true, // ?
